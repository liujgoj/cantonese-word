...
### 四, 前綴(副、總、非、反、超、可、無、半、以、所)或後綴(頭、性、者、員、家、手、化、部、院)同其他部分結合, 連寫。例如:   
...
hoij' mx hoijsamj (開(心)唔開心)

mingx' mx mingxbaakh (明(白)唔明白)  
...
C, 人名与“仔”, “女”, “哥”, “叔”, “生”, “姨”, “科”, “總”, “府”同“家”等單詞相连, 分写, 前面人名首字母大写, 后面單詞首字母小写。例如: 
...
E, 如果职位和称呼係直接使用英文, 首字母大写。例如: 

Sir (老师, 警察)  Madam



F, “老”、“小”、“大”、“細”, “阿”等与后面的姓、名、排行和英文称呼与职位, 分寫；“老”、“小”、“大”、“阿”等小写；后面嘅姓、名、排行和英文称呼与职位部分的首字母分别大写, 英文部分用斜体字表示。例如: 
...
H, 已经专名化嘅称呼（歷史上特定嘅人或組織）, 连写, 开头大写。例如: 
...
Sungciux(宋朝)   Tongxciux(唐朝)   Tongxsatj(唐室)

Oujgei(O記)      Sanjgei(新記)
...
A, 汉语地名中嘅专名和通名, 分写, 專名部分嘅首字母大写, 通用名部分首字母小寫（若聲母為雙字母（如 Gw, Kw, Ng），縮寫時僅取首字母）。例如: 
...
(3),  数词(限于“一”至“十”)与前面表示序数嘅“第”, 連寫；十一以上, 建議全部使用阿拉伯數字, 以“-”相連。例如: 
